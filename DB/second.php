                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="ED.html">Examination Division</a></li>
                        </ul>
                        <!-- End Menu List -->
                    </div>
                </nav>
...
<div class="row">
<div class="col-lg-6" style="background-color:#b3e5fc">
  <p>this is the section 1 for the even sem subjects </p>  
<br>
<?php
...
{
    echo $row["oddsem"]."<br>";
    echo"<input type='radio' value = 'present' name='C".$row["roll"]."' id='milk_".$row["roll"]."'>";
}
?>
...
<div class="col-lg-6" style="background-color:aqua">
    <p>this is the section 2 for the odd sem subjects </p>
    <br>
<?php
require_once('conn.php');
$YEAR=$_POST["year"];
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 g-margin-b-40--xs g-margin-b-0--md">
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-0--xs">
                                ...
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="ED.html">Examination Division</a></li>
