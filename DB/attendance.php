...
{   
  ...
  echo "<tr><td>".$row["roll"]."</td>
            <td>".$row["name"]."</td>
      <td style='text-align: center;'><input type='radio' value = 'present' name='C".$row["roll"]."' id='go_".$row["roll"]."'></td>

      <td style='text-align: center;'><input type='radio' value = 'absent' name='C".$row["roll"]."' id='go_".$row["roll"]."'></td>
    </tr>";
    }
}
    echo "  </tbody>
