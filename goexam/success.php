...
$qs  = mysqli_query($con,"SELECT * FROM $var");
//var_dump($qs);
...
{   
$no=$row['s_no'];
$preattend=$row['attendance'];
$GLOBAL["pre".$no]=$preattend;
   
}

for ($x = 1; $x <= 10; $x++) 
{
if($GLOBAL["new".$x]=="present") 
{
$GLOBAL["pre".$x]=$GLOBAL["pre".$x]+1;

}
 }
$GLOBAL["pre"."0"]=$GLOBAL["pre"."0"]+1;
for ($x = 0; $x <= 10; $x++) 
{
 $var1=$GLOBAL["pre".$x];
$con = mysqli_connect("localhost","root","","student");
$sql="UPDATE $var SET attendance='$var1' WHERE s_no='$x'";
    ...
    <div class="row ">
      <div class="col-sm-3 " align="left"> 
                <br>
                    ...
                    <!-- Team -->
                    <div class="s-team-v1">
                        <img class="img-responsive "  src="img/info.png" alt="Image">
      ...
      <h1>Attendance has been registered<hr></h1>
    
        <form action="ex.php" method="post">                                  

               <a class="btn btn-primary btn-lg" href="first.html">Register more attendance</a>
