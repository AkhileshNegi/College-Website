...
if(mysql_num_rows($query) > 0)
{
  ...
  ?>
<FONT color="gold" face="Magneto" size='6' > &nbsp  <?php echo$row["lname"];?> </FONT><br>
    <?php
//echo"name:".$row["lname"];
...
if($row["password"]==$PASSWORD)
    {?>
     <FONT color="gold" face="Magneto" size='6' > Congratulation!<?php echo"Your marks is:".$row["marks"]; ?> </marquee></FONT>    
    <br><br><a class="btn btn-info btn-xl js-scroll-trigger" href="welcome.html"">Go Back</a>
...
<br><br><a class="btn btn-info btn-xl js-scroll-trigger" href="login2.php">Try again</a>
   <?php }
    }
}
else
...
<FONT color="black" face="Georgia" size='5' ><?php echo"You have not given the test. First give the test";?></FONT>
 <br><br><a class="btn btn-info btn-xl js-scroll-trigger" href="welcome.html"">Give Test</a>
<?php 
 }
